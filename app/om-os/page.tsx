      ...
      <div className=" bg-orange-300 px-6 pt-24 sm:px-32 ">
        <div className="prose-base grid-cols-2 align-top sm:grid ">
          <div>
            ...
            <p>
              {" "}
              I mit arbejde som psykolog lægger jeg stor vægt på at møde dig
              åbent og respektfuldt. Jeg vil altid bestræbe mig på at skabe et
              trygt og roligt rum med plads og tid til at udforske det, der
              fylder hos dig. Det kan være både små og store ting, som du ønsker
              at forstå bedre eller ændre på i dit liv. Alle mennesker oplever
              kriser og svære perioder i løbet af livet, hvor det kan være rart
              at tale med nogen. Det kan også være, du oplever at være fastlåst
              i bestemte mønstre. Det kræver ofte tilløb og mod at starte i
              terapi, og jeg vil tage omsorgsfuldt imod dig.
            </p>
            <p>
              {" "}
              Jeg er optaget af sammenhængen mellem krop, følelser og tanker,
              samt de fortællinger og overbevisninger, vi bærer med os. Jeg
              anvender elementer fra blandt andet narrative og kognitive
              tilgange. Mit mål er, at du oplever en positiv forandring i din
              hverdag, hvorfor metoderne naturligvis tilpasses lige netop det,
              du står i. Jeg beskæftiger mig blandt andet med stress, angst,
              depression, lavt selvværd og relationer.
            </p>
            <p>
              Jeg har tidligere arbejdet med børn, unge og familier i kommunalt
              regi (Pædagogisk Psykologisk Rådgivning), samt varetaget
              supervision og sparring med personale og ledelse på skoler og i
              dagtilbud. Under min studietid har jeg desuden haft tilknytning
              til psykiatrien, herunder Klinik for OCD og Angstlidelser.{" "}
            </p>
            <p>Kontakt Thea</p>
            <p>Telefon til praksis: 25331100</p>
